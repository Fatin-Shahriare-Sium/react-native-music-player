        ...
        >
          <View style={styles.audioPlayeWrapper}>
            ...
            <View style={styles.sliderWrapper}>
              <View style={{ width: Dimensions.get("window").width * 0.7 }}>
                <Slider
                  ...
                  value={
                    audioUpdateStatus.currentDuration == 0
                      ? 0
                      : audioUpdateStatus.currentDuration /
                        audioUpdateStatus.totalDuration
                  }
                />
                <View
                  style={{
                ...
                >
                  <Text style={{ color: "white" }}>
                    {handleDurationFormat(audioUpdateStatus.currentDuration)}
                  </Text>
                  <Text style={{ color: "white" }}>
                    {handleDurationFormat(audioUpdateStatus.totalDuration)}
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.controllerWrapper}>
              <Pressable
                onPress={isFav == true ? deleteAudioAsFav : setAudioAsFav}
              >
                <View>
              ...
              <Pressable onPress={playNextFunc}>
                <Image style={{ width: 32, height: 32 }} source={nextIcon} />
              </Pressable>
              <Pressable onPress={determineIconFunc}>
                <Image
                  style={{ width: 32, height: 32 }}
                  source={determineIcon()}
                />
              </Pressable>
            </View>
          </View>
